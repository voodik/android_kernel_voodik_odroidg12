...
#define VERSION "v0.9-131-g0150346"
#ifndef VERSION
...
/*
int xpadneo_init_consumer(struct xpadneo_devdata *);
int xpadneo_init_keyboard(struct xpadneo_devdata *);
int xpadneo_init_synthetic(struct xpadneo_devdata *, char *, struct input_dev **);
*/
#endif
